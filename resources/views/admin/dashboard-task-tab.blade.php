...
<div class="row g-3 mb-4">
                    ...
                    @forelse ($todayFollowUps as $followup)
                        <div class="dashboard-item d-flex justify-content-between align-items-start">
                            ...
                            <div class="d-flex align-items-center gap-1">
                                ...
                                <span
                                    class="badge rounded-pill bg-{{ $followup->status === 'completed' ? 'success' : 'warning' }}">
                                    <i
                ...
                @forelse ($todayTasks as $task)
                    <div class="dashboard-item d-flex justify-content-between align-items-start">
                        ...
                        <div class="d-flex align-items-start gap-2">
                            ...
                            @if ($task->staff)
                                <div class="avatar-circle" title="{{ $task->staff->name }}">
                                    {{ strtoupper(substr($task->staff->name, 0, 1)) }}
                                </div>
                            @endif
    ...
    <div class="col-xl-4 col-lg-12">
        ...
        <div class="card shadow-sm border-0 h-100 dashboard-card overdue-card">
            ...
            <div class="card-footer bg-transparent border-0 text-end">
                <a href="{{ route('user-task.index', ['filter' => 'pending']) }}" class="small fw-semibold text-warning">
                    Resolve now →
                </a>
            </div>
    ...
    <div class="col-xl-4 col-lg-12">
        ...
        <div class="card shadow-sm border-0 h-100 dashboard-card overdue-card">
            ...
            <div class="card-footer bg-transparent border-0 text-end">
                <a href="{{ route('user-task.index', ['filter' => 'overdue']) }}" class="small fw-semibold text-danger">
                    Resolve now →
                </a>
            </div>
