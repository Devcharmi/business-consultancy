        ...
        <div class="card custom-card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <ul class="nav nav-tabs card-header-tabs" role="tablist">
                    <li class="nav-item">
                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#other-tab" type="button" role="tab">
                            Task Statistics
                        </button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#today-tasks-tab" type="button" role="tab">
                                    ...
                                    <div class="calendar-body">
                                        ...
                                        @for($i = 0; $i < 6; $i++) {{-- 6 weeks max --}}
                                            ...
                                            @for($j = 0; $j < 7; $j++)
                                                ...
                                                $currentDay=Carbon\Carbon::createFromDate($prevMonth->year, $prevMonth->month, $dayNumber);
                                                    ...
                                                    $currentDay = Carbon\Carbon::createFromDate($nextMonth->year, $nextMonth->month, $dayNumber);
                                                    $nextMonthDay++;
                                                    }
                                                    ...
                                                    <div class="calendar-day {{ !$isCurrentMonth ? 'calendar-day-other-month' : '' }} {{ $isToday ? 'calendar-day-today' : '' }}">
                                                        ...
                                                        <div class="calendar-day-content">
                                                            ...
                                                            $expertiseInitial = strtoupper(substr($expertise->name ?? 'N', 0, 1));
                                                            $expertiseColor = $expertise->color_name ?? '#6c757d';
                                                            @endphp
                                                            <div class="calendar-event mb-1" >
                                                                <div class="d-flex align-items-center gap-1" style="background-color: {{ $expertiseColor }}">
...
$(document).ready(function() {
    $(document).on('click', '.calendar-add-btn', function() {
        ...
        $('#modal-container').html('<div class="text-center p-5"><i class="bi bi-hourglass-split fs-1"></i><p>Loading...</p></div>');
            ...
            error: function(xhr) {
                if (xhr.status === 422) {
                    ...
                    $.each(errors, function(k, v) {
                        var id_arr = k.split(".");
                        $('#consulting_form').find('#' + id_arr[0] + '_error').text(v);
                    });
