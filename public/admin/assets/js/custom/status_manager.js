var status_table = $(".table-list").DataTable({
    order: [[0, "desc"]],
    autoWidth: false,
    processing: true,
    serverSide: true,
    ...
    ajax: {
        url: $("#status_table").attr("data-url"),
    },
    columns: [
        {
            data: "id",
        ...
        },
        {
            ...
            mRender: function (v, t, o) {
                ...
                edit_path_set = edit_path_set.replace(":status_manager", id);
...
$(document).on("click", "#status_form_button", function () {
